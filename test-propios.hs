...
testsEjmodernizarFlota = test [       -- YA LO REVISE
    ...
    "flota modernizada con dos elemento" ~: modernizarFlota [("BsAs", "Chubut", 10.0),("Chubut","Salta",9.8)] ~?= [("BsAs", "Chubut", 9.0),("Chubut","Salta",8.82)],
    "no hay oferta de vuelos" ~: modernizarFlota [] ~?= [],
    "vuelos con duraciones muy bajas"~: modernizarFlota [("BsAs", "Rosario", 0.1)] ~?= [("BsAs", "Rosario", 0.09)]
    ]
